...
const SITE = {
  ...
  hero: {
    ...
    ctaPrimary: { label: "Check Availability", href: "https://airbnb.com/rooms/example" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white transition"
          >
    ...
    <Section id="contact" title="Contact the Host">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 bg-white dark:bg-zinc-900 shadow-sm h-max">
          ...
          <a href={SITE.hero.ctaPrimary.href} className="mt-4 inline-flex items-center gap-2 rounded-2xl px-4 py-2 bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white">
            Book Now <ExternalLink size={16}/>
          </a>
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-3">Prefer direct booking? Add Stripe Checkout here for deposit-only reservations.</p>
        </div>
      </div>
    </Section>
  );
